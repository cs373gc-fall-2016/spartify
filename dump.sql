...
COPY companies (id, name, url, description) FROM stdin;
1	Google	https://github.com/google	
2	Facebook	https://github.com/facebook	We work hard to contribute our work back to the web, mobile, big data, & infrastructure communities. NB: members must have two-factor auth.
3	Microsoft	https://github.com/microsoft	Open source, from Microsoft with love
\.
...
COPY contributors (id, username, email, url) FROM stdin;
1	haberman	jhaberman@gmail.com	https://github.com/haberman
2	modocache	modocache@gmail.com	https://github.com/modocache
3	tompaana	\N	https://github.com/tompaana
\.
...
COPY projects (id, name, url, owner_id, description) FROM stdin;
1	upb	https://github.com/google/upb	1	small, fast parsers for the 21st century
2	codemod	https://github.com/facebook/codemod	2	Codemod is a tool/library to assist you with large-scale codebase refactors that can be partially automated but still require human oversight and occasional intervention. Codemod was developed at Facebook and released as open source.
3	protractor	https://github.com/Microsoft/protractor	3	HTML5 application for Windows Phone that allows the screen to be used as protractor/ruler to measure lengths and angles.
\.
